  ...
  return (
    <header className="h-20 shadow-md bg-white">
      <div className="h-full container mx-auto flex items-center px-5 justify-between">
        ...
        <div className="hidden lg:flex items-center w-full justify-between max-w-md border rounded-full focus-within:shadow-md pl-4">
          <input
            ref={inputRef}
            type="text"
        ...
        <div className="flex items-center gap-7 select-none">
          <div className="relative flex justify-center">
            ...
            <div
              ...
              className={`text-3xl ${!disableMenu && "cursor-pointer"} relative flex justify-center`}
            >
              {user?.profilePic ? (
                <img
                  src={user.profilePic}
          ...
          <div>
            {user?._id ? (
              <button
                ...
                className="text-xl px-3 bg-cyan-600 py-1 rounded-full text-white hover:bg-cyan-700"
              >
                Logout
              </button>
            ) : (
